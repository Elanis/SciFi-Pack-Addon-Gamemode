...
function ENT:SpawnFunction( ply,tr )
	...
	local ent = ents.Create("b5_vorchan") --SpaceShip entity
	ent:SetPos( tr.HitPos + Vector(0,0,220))
	ent:Spawn()
	ent:Activate()
	return ent
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/mymodel/vorchan/vorchan.mdl")
		 ...
		 local move = { }
			 ...
			 move.pos = self.Entity:GetPos()+self.Entity:GetForward()*self.Speed
                ...
                elseif self.Pilot:KeyDown( IN_JUMP ) then
                   move.pos = move.pos+self.Entity:GetRight()*-300
