...
hook.Add( "BSGTab", "AddBSGEntity", function( pnlContent, tree, node )

	local Categorised = {}
	
	-- Add this list into the tormoil
	local Vehicles = list.Get( "BSG.Vehicles" )		
	if ( Vehicles ) then
	...
	-- Add this list into the tormoil
	local SpawnableEntities = list.Get( "BSG.Ent" )
	...
	for CategoryName, v in SortedPairs( Categorised ) do
		...
		local lines = BSG.SpawnList.Props;
...
spawnmenu.AddCreationTab("BSG",function()
		local ctrl = vgui.Create( "SpawnmenuContentPanel" )
		ctrl:CallPopulateHook( "BSGTab" );
		return ctrl
