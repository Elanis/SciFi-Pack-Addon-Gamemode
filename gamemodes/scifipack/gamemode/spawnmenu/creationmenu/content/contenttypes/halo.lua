...
hook.Add( "HaloTab", "AddHaloEntity", function( pnlContent, tree, node )

	local Categorised = {}
	
	-- Add this list into the tormoil
	local Vehicles = list.Get( "Halo.Vehicles" )		
	if ( Vehicles ) then
	...
	-- Add this list into the tormoil
	local SpawnableEntities = list.Get( "Halo.Ent" )
	...
	for CategoryName, v in SortedPairs( Categorised ) do
		...
		local lines = Halo.SpawnList.Props;
...
spawnmenu.AddCreationTab("Halo",function()
		local ctrl = vgui.Create( "SpawnmenuContentPanel" )
		ctrl:CallPopulateHook( "HaloTab" );
		return ctrl
